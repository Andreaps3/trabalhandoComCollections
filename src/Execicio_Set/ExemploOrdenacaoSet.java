...
Scandal, genero: drama, tempEpisodio: 60
Série 2 = Nome: The Big Bang Theory, genero: comédia, tempEpisodio: 30
Série 3 = Nome: The Sinner '70s show, genero: Mystery, tempEpisodio: 45
 */
...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<>(){{
            add(new Serie("Scandal","drama",60));
            add(new Serie("The Big Bang","comedia", 30));
            add(new Serie("The Siner", "Mystery", 45));
